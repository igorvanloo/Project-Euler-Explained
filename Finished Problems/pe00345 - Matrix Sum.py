...
After taking a linear programming course last semester I recognize this as an assignment problem

I use scipy.optimize.linear_sum_assignment to solve this using the Hungarian Method

Anwser:
    13938
--- 0.0010144710540771484 seconds ---
'''
